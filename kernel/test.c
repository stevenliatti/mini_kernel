...
void test_fs() {
	...
	print_title("\t-- File descriptor "); printf("%d", fd);
	print_title(" after file_read all content:\n");
	test_file_descriptior(fd, expected_fd_struct[1]);
	print_test_num();
	getc();
	clr_scr();

	print_title("\n-- file_seek to position 1017 of the file "); printf("\"%s\"", filename);
	print_title(" and read 21 character:\n");
	file_seek(fd, 1017);
	print_title("\t-- File descriptor "); printf("%d", fd);
	print_title(" after file_seek(fd, 1017):\n");
	...
	print_title("\t-- File descriptor "); printf("%d", fd);
	print_title(" after file_read of 21 character:\n");
	...
	print_title("\n-- file_seek to position 1160 of the file "); printf("\"%s\"", filename);
	print_title(" and read 100 character:\n");
	file_seek(fd, 1160);
	print_title("\t-- File descriptor "); printf("%d", fd);
	print_title(" after file_seek(fd, 1160):\n");
	...
	print_title("\t-- File descriptor "); printf("%d", fd);
	print_title(" after file_read of 100 character:\n");
